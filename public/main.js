var app = (function () {
  ...
  function Nt(t) {
    ...
    return {
      c() {
        (n = w("div")),
        (n.innerHTML =
          '<p class="mb-3">Un clon de <a href="https://www.heardle.app/" title="Heardle">Heardle</a>, pero con canciones en español</p>            \n\n<p class="mb-3">Las canciones son elegidas de forma aleatoria</p> \n\n<p class="mb-3">Gracias por jugar! <a href="https://twitter.com/HeardlEsp" title="@HeardlEsp">@HeardlEsp</a></p> \n\n\n\n<p class="text-xs mb-3 text-custom-line">Hecho con <a href="https://developers.soundcloud.com">Soundcloud</a>,\n <a href="https://svelte.dev">Svelte</a>,\n <a href="https://tailwindcss.com">Tailwind</a>,\n <a href="https://fonts.google.com/noto/specimen/Noto+Serif+Display">Noto Serif Display</a>, <a href="https://fonts.google.com/noto/specimen/Noto+Sans">Noto Sans</a>,\n <a href="https://iconsvg.xyz">IconSVG</a>, <a href="https://momentjs.com">momentjs</a>,\n <a href="https://tarekraafat.github.io/autoComplete.js/#/">autocomplete.js</a>, y desarrollado con <a href="https://glitch.com/">Glitch</a>. <br></br>Agradecimientos a <a href="https://twitter.com/ClomatikArt">ClomatikArt</a> por ofrecer la <a href="https://open.spotify.com/playlist/6YcJI1QspB65yowYylnqji?si=9de1366b27194efb">playlist</a> inicial y tocar lo mínimo del código, <a href="https://twitter.com/POISONP1NK">POISONP1NK</a> por sus dibujos, y <a     href="https://twitter.com/minaszns">Minaszns</a> por stanear a Twice. <br></br>Versión española hecha por <a href="https://twitter.com/HachebeDLC">HachebeDLC</a>.</p>'),
        M(n, "class", "text");
      },
      m(e, t) {
        g(e, n, t);
    ...
    return {
      c() {
        ...
        M(
          ...
          M(r, "href", "https://ko-fi.com/heardlesp"),
  ...
  function jt(e, t, n) {
    ...
    return (
      P(async function () {
        (async function () {
          const e = await fetch("https://heardlesp.glitch.me/supporters.json");
          return await e.json();
        })().then((e) => {
          n(0, (r = e.supporters));
        });
    ...
    return (
      ...
      (u = new Bt({})), {
        c() {
          (n = w("p")),
          (n.textContent =
            "Si te ha gustado el juego y quieres apoyar a los desarrolladores, considera donar un leuro"),
          (r = x()),
          (s = w("p")),
          (s.innerHTML =
            '<p class="mb-3">Si te ha gustado, apoya a los <a href="https://ko-fi.com/hachebedlc">desarrolladores de HeardlEsp</a>.</p>'),
          (i = x()),
          (o = w("div")),
          Q(a.$$.fragment),
            (l = x()),
  ...
  const Vt = {
    ...
    Jt = [
      "Illo...? 😔", // FAILED
      "Flamisima!!!!", // First try
      "Te lo perdono si no se escuchaba nada antes de hacer skip",
      "A la tercera va la vencida",
      "Podría haber sido peor",
      "Por poquito eh",
      "Casi pa Septiembre", // Sixth try
    ];
...
`),
  ...
  function tn(e) {
    ...
    function n(e, t) {
     return e[0][e[12]].isSkipped ?
      sn : e[0][e[12]].isArtist && !e[0][e[12]].isSkipped ?
      wan: e[0][e[12]].isCorrect || e[0][e[12]].isSkipped ?
      e[0][e[12]].isCorrect ?
      nn :
      void 0 :
      rn
  ...
  function an(e) {
    ...
    return {
      c() {
        (t = _("Has sacado el HeardlEsp de hoy en los primeros ")),
        (n = _(s)),
        (r = _(" segundos."));
      },
      m(e, s) {
  ...
  function ln(e) {
    ...
    return {
      c() {
        (t = _("Has sacado el HeardlEsp de hoy en el ")),
        (n = _(o)),
        (r = _("\n                segundo")),
        (s = _(a)),
        (i = _("."));
  ...
  function un(t) {
    ...
    return {
      c() {
        n = _("No has adivinado el HeardlEsp de hoy. ¡Más suerte mañana!");
      },
      m(e, t) {
        g(e, n, t);
      },
  ...
  const Cn = ue([
      ...
      "Despistaos - Cada dos minutos (con Rulo y la Contrabanda y Kutxi Romero)",
      "Chayanne - Torero",
      ...
      "Manolo García - Carbon y Ramas Secas",
      "Miguel Bosé - Linda",
      ...
      "Raffaella Carra - Hay Quel Venir al Sur",
      "Maria Isabel - Antes Muerta Que Sencilla",
      "Sex Bomb - Ven, Ven, Ven",
      ...
      "Ay Em - Te Boté (Remix) [feat. Darell, Nicky Jam & Ozuna]",
      "Thalia - No Me Acuerdo",
      "Becky G - Becky G & Natti Natasha - Sin Pijama",
      ...
      "Nicky Jam Music - El Perdón (with Enrique Iglesias)",
      "Carlos Sadness - Te Quiero un Poco",
      "Carlos Sadness - Amor Papaya",
      "Celtas Cortos - 20 de Abril",
      "La Casa Azul - La Revolución Sexual",
      "Bad-Bunny - Bad Bunny, El Alfa - La Romana",
      "MS NINA - Tu Sicaria",
      "Ladilla Rusa - KITT y los coches del pasado (feat. Joan Colomo, Los Ganglios, Laura Santos & Lady Gipsy)",
      "BADGYAL - Fiebre (Prod. King DouDou)",
      ...
      "María Peláe - Mi Tio Juan",
      "Super-G - El Armario Quedó Atrás",
    ]),
    //Estas pos ya las canciones guardadas con su link pa que suenen etc
    On = {
      subscribe: ue(
        [{
            answer: "Miguel Bosé - Morenamía ", //27-Marzo-2022
            url: "https://soundcloud.com/bosemiguel/morenamia-dueto-2007",
          },
          {
            answer: "Miguel Bosé - Amante bandido",
            url: "https://soundcloud.com/bosemiguel/amante-bandido-dueto-2007",
          },
          {
            answer: "Mecano - Maquillaje",
            url: "https://soundcloud.com/mecano-official/maquillaje-1",
          },
          {
            answer: "Alex Ubago - Aunque no te pueda ver",
            url: "https://soundcloud.com/alexubago/aunque-no-te-pueda-ver",
          },
          {
            answer: "Radio Futura - Escuela de Calor",
            url: "https://soundcloud.com/radiofuturaofficial/escuela-de-calor-3",
          },
          {
            answer: "Amaia Montero - Por Toda Una Vida",
            url: "https://soundcloud.com/amaia-montero/por-toda-una-vida",
          },
          {
            answer: "El Arrebato - Dime Tu Nombre",
            url: "https://soundcloud.com/el-arrebato/dime-tu-nombre",
          },
          {
            answer: "Melendi - Tu jardín con enanitos",
            url: "https://soundcloud.com/melendi-official/tu-jard-n-con-enanitos",
          },
          {
            answer: "Pereza - Estrella Polar",
            url: "https://soundcloud.com/perezaofficial/estrella-polar",
          },
          {
            answer: "Celtas Cortos - Cuéntame un cuento",
            url: "https://soundcloud.com/celtas-cortos-official/cuentame-un-cuento",
          },
          {
            answer: "La Cabra Mecanica - La lista de la compra",
            url: "https://soundcloud.com/la-cabra-mecanica/la-lista-de-la-compra-version",
          },
          {
            answer: "Mecano - Me Colé en una Fiesta",
            url: "https://soundcloud.com/mecano-official/me-col-en-una-fiesta-1",
          },
          {
            answer: "El sueño de Morfeo - Para toda la vida",
            url: "https://soundcloud.com/el-sueno-de-morfeo/para-toda-la-vida",
          },
          {
            answer: "David Civera - Que La Detengan",
            url: "https://soundcloud.com/danielvela-music/que-la-detengan-2",
          },
          {
            answer: "Melendi - Un violinista en tu tejado",
            url: "https://soundcloud.com/melendi-official/un-violinista-en-tu-tejado",
          },
          {
            answer: "Nek - Laura no està",
            url: "https://soundcloud.com/nek-official/laura-no-est",
          },

          {
            answer: "Nacha Pop - Chica de ayer",
            url: "https://soundcloud.com/nacha-pop/chica-de-ayer",
          },
          {
            answer: "La Guardia - Cuando Brille el Sol",
            url: "https://soundcloud.com/la-guardia-official/cuando-brille-el-sol",
          },
          {
            answer: "Mecano - Hijo de la luna",
            url: "https://soundcloud.com/mecano-official/hijo-de-la-luna",
          },
          {
            answer: "Pignoise - Estoy enfermo",
            url: "https://soundcloud.com/pignoise/estoy-enfermo-con-melendi",
          },

          {
            answer: "Melendi - Piratas del bar Caribe",
            url: "https://soundcloud.com/melendi-official/piratas-del-bar-caribe",
          },
          {
            answer: "Mónica Naranjo - Sobreviviré",
            url: "https://soundcloud.com/monica-naranjo-official/sobrevivir",
          },
          {
            answer: "Efecto Mariposa - Diez minutos", //18-Abril-2022
            url: "https://soundcloud.com/efecto-mariposa/diez-minutos",
          },
          {
            answer: "Maldita Nerea - El Secreto de las Tortugas",
            url: "https://soundcloud.com/maldita-nerea/el-secreto-de-las-tortugas",
          },
          {
            answer: "Celtas Cortos - 20 de Abril", //probablemente el peak de la comedia
            url: "https://soundcloud.com/celtas-cortos-official/20-de-abril-1#t=00:03",
          },
          {
            answer: "Manolo García - A San Fernando un Ratito a Pie y Otro Caminando",
            url: "https://soundcloud.com/manolo-garcia-official/a-san-fernando-un-ratito-a-pie",
            timeout: 3000,
          },
          {
            url: "https://soundcloud.com/selena-gomez-official/baila-conmigo",
            answer: "Selena Gomez - Baila Conmigo (with Rauw Alejandro)",
          },
          {
            url: "https://soundcloud.com/nino-bravo-official/libre",
            answer: "Nino Bravo - Libre",
          },
          {
            answer: "Mecano - Barco a Venus",
            url: "https://soundcloud.com/mecano-official/barco-a-venus-1",
          },
          {
            answer: "Juanes - La Camisa Negra",
            url: "https://soundcloud.com/juanes-unplugged/la-camisa-negra-album-version",
          },
          {
            url: "https://soundcloud.com/el-sueno-de-morfeo/nunca-volvera",
            answer: "El sueño de Morfeo - Nunca volverá",
            timeout: 2700,
          },
          {
            answer: "Marc Anthony - Valió la Pena ",
            url: "https://soundcloud.com/marcanthonyofficial/valio-la-pena",
          },
          {
            answer: "Amaral - Toda la noche en la calle",
            url: "https://soundcloud.com/amaral-official/toda-la-noche-en-la-calle",
          },
          {
            answer: "Fangoria - A quién le importa",
            url: "https://soundcloud.com/fangoria-official/a-quien-le-importa",
          },
          {
            answer: "Manolo García - Carbon y Ramas Secas",
            url: "https://soundcloud.com/manolo-garcia-official/carbon-y-ramas-secas",
          },
          {
            url: "https://soundcloud.com/marisolofficial/coraz-n-contento-1", //01-Mayo-2022
            answer: "Marisol - Corazón Contento",
          },
          {
            url: "https://soundcloud.com/albertogambinoofficial/purpurina",
            answer: "Alberto Gambino - Purpurina",
            timeout: 1000,
          },
          {
            answer: "Estopa - Por la Raja de Tu Falda",
            url: "https://soundcloud.com/estopa-official/por-la-raja-de-tu-falda",
          },
          {
            url: "https://soundcloud.com/sebastianyatra/sebastian-yatra-tacones-rojos",
            answer: "Sebastián Yatra - Tacones Rojos",
          },
          {
            url: "https://soundcloud.com/malu-official/blanco-y-negro",
            answer: "Malu - Blanco y Negro",
            timeout: 1000,
          },
          {
            url: "https://soundcloud.com/cnco/reggaeton-lento-bailemos",
            answer: "CNCO - Reggaetón Lento (Bailemos)",
          },
          {
            url: "https://soundcloud.com/antonio-flores-official/no-dudaria",
            answer: "Antonio Flores - No Dudaria",
          },
          {
            answer: "Mecano - Cruz de navajas",
            url: "https://soundcloud.com/mecano-official/cruz-de-navajas",
          },
          {
            answer: "Alejandro Sanz - Te lo agradezco, pero no",
            url: "https://soundcloud.com/warnermusicspain/alejandro-sanz-te-lo-agradezco",
            timeout: 2000,
          },
          {
            answer: "Efecto Mariposa - Por quererte",
            url: "https://soundcloud.com/efecto-mariposa/por-quererte",
          },
          {
            answer: "Pereza - Princesas",
            url: "https://soundcloud.com/perezaofficial/princesas",
          },
          {
          ...
          {
            answer: "Amaral - Te necesito",
            url: "https://soundcloud.com/amaral-official/te-necesito",
          },
          {
            answer: "El Canto Del Loco - Peter Pan",
            url: "https://soundcloud.com/el-canto-del-loco/peter-pan-2",
          },
          {
            url: "https://soundcloud.com/bustamante-official/no-soy-un-superman-album",
            answer: "Bustamante - No Soy Un Superman",
          },

          {
            answer: "Marta Sánchez - Soy Yo",
            url: "https://soundcloud.com/marta-sanchez-official/soy-yo-album-version",
          },
          {
            answer: "Amaia Montero - Quiero Ser",
            url: "https://soundcloud.com/amaia-montero/quiero-ser",
          },
          {
            answer: "Amaral - Sin ti no soy nada",
            url: "https://soundcloud.com/amaral-official/sin-ti-no-soy-nada",
            timeout: 1200,
          },
          {
            url: "https://soundcloud.com/melody89613/el-baile-del-gorila",
            answer: "Melody - El Baile del Gorila",
          },
          {
            url: "https://soundcloud.com/morat-official/cuando-nadie-ve",
            answer: "Morat - Cuando Nadie Ve",
          },
          {
            answer: "Mecano - Un Año Mas",
            url: "https://soundcloud.com/mecano-official/un-a-o-mas",
          },
          {
            url: "https://soundcloud.com/marcsegui/360a1",
            answer: "Marc Seguí - 360",
          },
          {
            answer: "Amaral - El universo sobre mí",
            url: "https://soundcloud.com/amaral-official/el-universo-sobre-mi-2012",
          },
          {
            url: "https://soundcloud.com/nickyjamcol/el-perdon",
            answer: "Nicky Jam Music - El Perdón (with Enrique Iglesias)",
          },
          {
            url: "https://soundcloud.com/tequilaofficial/salta",
            answer: "Tequila - Salta!!!",
          },
          {
            url: "https://soundcloud.com/djsnake/taki-taki-feat-selena-gomez",
            answer: "DJ Snake - Taki Taki ft. Selena Gomez, Ozuna, Cardi B",
          },
          {
            url: "https://soundcloud.com/el-canto-del-loco/la-madre-de-jose",
            answer: "El Canto Del Loco - La Madre de Jose",
          },
          {
            answer: "Melendi - Caminando por la vida",
            url: "https://soundcloud.com/melendi-official/caminando-por-la-vida",
            timeout: 3750,
          },
          {
            answer: "Shakira - Lo Hecho Está Hecho",
            url: "https://soundcloud.com/shakira/lo-hecho-est-hecho",
          },
          {
            url: "https://soundcloud.com/lacasaazul-music/la-revolucion-sexual",
            answer: "La Casa Azul - La Revolución Sexual",
          },
          {
            url: "https://soundcloud.com/raffaella-carra-official/hay-quel-venir-al-sur",
            answer: "Raffaella Carra - Hay Quel Venir al Sur",
          },
          {
            answer: "Mecano - Mujer contra mujer", //1
            url: "https://soundcloud.com/mecano-official/mujer-contra-mujer",
            timeout: 500
          },
          {
            answer: "Mónica Naranjo - Sobreviviré", //2
            url: "https://soundcloud.com/monica-naranjo-official/sobrevivir",
          },
          {
            "answer": "Chenoa - Cuando Tú Vas",
            "url": "https://soundcloud.com/chenoa-official/cuando-t-vas-album-version?in=clo-matik/sets/orgullo/"
          },
          {
            "answer": "Los Ronaldos - No Puedo Vivir Sin Ti",
            "url": "https://soundcloud.com/losronaldos/no-puedo-vivir-sin-ti-2?in=clo-matik/sets/orgullo/"
          },
          {
            "answer": "Tino Casal - Embrujada",
            "url": "https://soundcloud.com/tino-casal-official/embrujada?in=clo-matik/sets/orgullo/",
            timeout: 600,
          },
          {
            "answer": "Rocio Durcal - La Gata Bajo la Lluvia",
            "url": "https://soundcloud.com/rocio-durcal-official/la-gata-bajo-la-lluvia?in=clo-matik/sets/orgullo/"
          },
          {
            "answer": "Raphael - Qué sabe nadie",
            "url": "https://soundcloud.com/raphael-official/qu-sabe-nadie-1?in=clo-matik/sets/orgullo/"
          },
          {
            "answer": "Calle 13 - Atrévete-Te-Te",
            "url": "https://soundcloud.com/calle13music/atr-vete-te-te-album-version?in=clo-matik/sets/orgullo/"
          },
          {
            "answer": "Cristina 'La Veneno' - Veneno Pa Tu Piel",
            "url": "https://soundcloud.com/cristinalaveneno-music/sets/veneno-pa-tu-piel?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing"
          },
          {
            "answer": "Yuri - Este Amor Ya No Se Toca",
            "url": "https://soundcloud.com/rosj694gw/este-amor-ya-no-se-toca?in=clo-matik/sets/orgullo/"
          },
          {
            "answer": "Esteman - Amor Libre",
            "url": "https://soundcloud.com/esteman-official/amor-libre-1?in=clo-matik/sets/orgullo/"
          },
          {
            "answer": "Miguel Bosé - Amante bandido 99",
            "url": "https://soundcloud.com/bosemiguel/amante-bandido-99?in=clo-matik/sets/orgullo/"
          },

          {
            "answer": "Raphael - Escándalo",
            "url": "https://soundcloud.com/raphael-official/escandalo-remastered?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing"
          },
          {
            "answer": "Miss Caffeina - Mira cómo vuelo",
            "url": "https://soundcloud.com/miss-caffeina-official/mira-c-mo-vuelo?in=clo-matik/sets/orgullo/"
          },
          {
            "answer": "La Unión - Vuelve el amor",
            "url": "https://soundcloud.com/la-union-official/vuelve-el-amor?in=clo-matik/sets/orgullo/",
            timeout: 2500,
          },
          {
            "answer": "Ricky Martin - Pégate",
            "url": "https://soundcloud.com/ricky-martin-official/p-gate-mtv-unplugged-version?in=clo-matik/sets/orgullo/"
          },
          {
            "answer": "Shakira - Loba",
            "url": "https://soundcloud.com/shakira/loba?in=clo-matik/sets/orgullo/"
          },
          {
            "answer": "Marta Sánchez - Soy Yo",
            "url": "https://soundcloud.com/marta-sanchez-official/soy-yo-album-version?in=clo-matik/sets/orgullo/",
            timeout: 1200,
          },
          {
            "answer": "Camilo Sesto - Vivir Así Es Morir de Amor",
            "url": "https://soundcloud.com/camilo-sesto-official/vivir-as-es-morir-de-amor-1?in=clo-matik/sets/orgullo/"
          },
          {
            "answer": "Fangoria - A quién le importa",
            "url": "https://soundcloud.com/fangoria-official/a-quien-le-importa?in=clo-matik/sets/orgullo/"
          },
          {
            "answer": "Mecano - Stereosexual",
            "url": "https://soundcloud.com/mecano-official/stereosexual?in=clo-matik/sets/orgullo/",
            timeout: 600,
          },
          // {
          //     "answer": "Ladilla Rusa - KITT y los coches del pasado (feat. Joan Colomo, Los Ganglios, Laura Santos &amp; Lady Gipsy)",
          //     "url": "https://soundcloud.com/ladillarusa/kitt-y-los-coches-del-pasado?in=clo-matik/sets/orgullo/",
          //   timeout:2300,
          // },
          {
            answer: "Mónica Naranjo - Desátame",
            url: "https://soundcloud.com/monica-naranjo-official/des-tame-1",
          },

          {
            "answer": "Rosalia - BIZCOCHITO",
            "url": "https://soundcloud.com/rosaliaofficial/bizcochito?in=clo-matik/sets/orgullo/"
          },
          {
            "answer": "Bustamante - Dos Hombres Y Un Destino",
            "url": "https://soundcloud.com/bustamante-official/dos-hombres-y-un-destino-a-duo?in=clo-matik/sets/orgullo/"
          },
          {
            "answer": "BADGYAL - Fiebre (Prod. King DouDou)",
            "url": "https://soundcloud.com/badgyalsc/fiebre-prod-king-doudou?in=clo-matik/sets/orgullo/"
          },
          {
            "answer": "Julieta Venegas - Limón y Sal",
            "url": "https://soundcloud.com/julietav/lim-n-y-sal?in=clo-matik/sets/orgullo/"
          },
          {
            "answer": "Gloria Trevi - Todos Me Miran",
            "url": "https://soundcloud.com/gloria-trevi-official/todos-me-miran-album-version?in=clo-matik/sets/orgullo/"
          },
          {
            "answer": "María Peláe - Mi Tio Juan",
            "url": "https://soundcloud.com/mariapelae-music/mi-tio-juan?in=clo-matik/sets/orgullo/",
            timeout: 500,
          },
          {
            "answer": "Super-G - El Armario Quedó Atrás",
            "url": "https://soundcloud.com/supergofficial/el-armario-quedo-atras?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            timeout: 3500
          },
          {
            url: "https://soundcloud.com/troupbandofficial/la-cancion-del-velero",
            answer: "Troup Band - La Canción del Velero",
          },
          {
            url: "https://soundcloud.com/warnermusicspain/alejandro-sanz-corazon-partio",
            answer: "Alejandro Sanz - Corazon partio",
          },
          {
            answer: "Alex Ubago - Sin miedo a nada",
            url: "https://soundcloud.com/alexubago/alex-ubago-sin-miedo-a-nada",
          },
          {
            answer: "Juanes - A Dios Le Pido",
            url: "https://soundcloud.com/juanes-unplugged/a-dios-le-pido",
          },
          {
            answer: "Fangoria - Retorciendo palabras",
            url: "https://soundcloud.com/fangoria-official/retorciendo-palabras",
          },
          {
            answer: "Mecano - Hawaii-Bombay",
            url: "https://soundcloud.com/mecano-official/hawaii-bombay-1",
            timeout: 8000
          },
          {
            answer: "Georgina - Supermujer",
            url: "https://soundcloud.com/georgina-official/supermujer",
          },
          {
            url: "https://soundcloud.com/lassupremasdemostoles/eres-un-enfermo",
            answer: "Las Supremas De Mostoles - Eres un enfermo",
            timeout: 11000
          },
          {
            url: "https://soundcloud.com/gipsy-kings-official/volare-nel-blu-di-pinto-di-blu",
            answer: "Gipsy Kings - Volare (Nel Blu di Pinto di Blu)",
          },
          {
            answer: "La Oreja De Van Gogh - Rosas",
            url: "https://soundcloud.com/la-oreja-de-van-gogh/rosas-3",
            timeout: 4000
          },
          {
            answer: "Shakira - Ciega, Sordomuda",
            url: "https://soundcloud.com/shakira/ciega-sordomuda",
          },

          {
            answer: "La Oreja De Van Gogh - Jueves",
            url: "https://soundcloud.com/la-oreja-de-van-gogh/jueves",
          },
          {
            answer: "El Barrio - Pa Madrid",
            url: "https://soundcloud.com/bailongos-va/el-barrio-pa-madrid",
            timeout: 4200
          },
          {
            url: "https://soundcloud.com/tino-casal-official/eloise",
            answer: "Tino Casal - Eloise",
            timeout: 1900
          },
          {
            answer: "Chambao - Pokito a Poko",
            url: "https://soundcloud.com/chambao/pokito-a-poko",
          },
          {
            url: "https://soundcloud.com/david-bisbal-official/buleria-album-version",
            answer: "David Bisbal - Buleria",
          },
          {
            answer: "El sueño de Morfeo - Nunca volverá",
            url: "https://soundcloud.com/el-sueno-de-morfeo/nunca-volvera",
          ...
          {
            answer: "La Guardia - El Mundo Tras el Cristal",
            url: "https://soundcloud.com/la-guardia-official/el-mundo-tras-el-cristal",
          },
          {
            answer: "Amaral - Días de verano",
            url: "https://soundcloud.com/amaral-official/dias-de-verano",
          },
          {
            answer: "Estopa - Pastillas para Dormir",
            url: "https://soundcloud.com/estopa-official/pastillas-para-dormir",
          },

          {
            answer: "La Oreja De Van Gogh - El Primer Día del Resto de Mi Vida",
            url: "https://soundcloud.com/la-oreja-de-van-gogh/el-primer-d-a-del-resto-de",
          },
          {
            url: "https://soundcloud.com/rosario-official/c-mo-quieres-que-te-quiera-1",
            answer: "Rosario - Cómo Quieres Que Te Quiera",
          },
          {
            answer: "Mecano - Hoy no me puedo levantar",
            url: "https://soundcloud.com/mecano-official/hoy-no-me-puedo-levantar-1",
          },
          {
            answer: "Aleks Syntek - Duele El Amor",
            url: "https://soundcloud.com/aleks-syntek/duele-el-amor-album-version",
          },
          {
            url: "https://soundcloud.com/azucar-moreno-official/bandido",
            answer: "Azucar Moreno - Bandido",
          },
          {
            url: "https://soundcloud.com/carlossadness/amor-papaya",
            answer: "Carlos Sadness - Amor Papaya",
          },
          {
            answer: "Amaral - Cómo hablar",
            url: "https://soundcloud.com/amaral-official/como-hablar-1",
          },
          {
            url: "https://soundcloud.com/david-bisbal-official/ave-mar-a-album-version",
            answer: "David Bisbal - Ave María",
          },
          {
            answer: "Fito & Fitipaldis - Entre la espada y la pared",
            url: "https://soundcloud.com/fitoyfitipaldis/entre-la-espada-y-la-pared",
            timeout: 700
          },
          {
            answer: "Juanes - Fotografía",
            url: "https://soundcloud.com/juanes-unplugged/fotografia",
          },
          {
            answer: "Chambao - Ahí Estás Tú",
            url: "https://soundcloud.com/chambao/ah-est-s-t",
            timeout: 1000
          },
          {
            answer: "Paulina Rubio - Ni Rosas Ni Juguetes",
            url: "https://soundcloud.com/paulina-rubio-official/ni-rosas-ni-juguetes-album",
          },
          {
            answer: "Rosario - No Dudaría",
            url: "https://soundcloud.com/rosario-official/no-dudar-a-album-version",
            timeout: 2000
          },
          {
            answer: "M-Clan - Llamando a la tierra (Serenade From the Stars)",
            url: "https://soundcloud.com/m-clan-official/llamando-a-la-tierra-serenade",
            timeout: 1000
          },
          {
            answer: "Juanes - Volverte A Ver",
            url: "https://soundcloud.com/juanes-unplugged/volverte-a-ver-album-version",
          },
          {
            url: "https://soundcloud.com/camaron-de-la-isla/soy-gitano-1",
            answer: "Camaron De La Isla - Soy Gitano",
            timeout: 1000
          },
          {
            url: "https://soundcloud.com/duncan-dhu/cien-gaviotas",
            answer: "Duncan Dhu - Cien gaviotas",
            timeout: 800
          },
          {
            answer: "Amaral - Marta, Sebas, Guille y los demás",
            url: "https://soundcloud.com/amaral-official/marta-sebas-guille-y-los-dem",
          },
          {
            url: "https://soundcloud.com/rocio-durcal-official/me-gustas-mucho-1",
            answer: "Rocio Durcal - Me Gustas Mucho",
          },
          {
            answer: "Joaquin Sabina - Y Nos Dieron las Diez",
            url: "https://soundcloud.com/joaquin-sabina-official/y-nos-dieron-las-diez",
          },
          {
            url: "https://soundcloud.com/rosaliaofficial/yo-x-ti-tu-x-mi",
            answer: "Rosalia - Yo x Ti, Tu x Mi",
          },
          {
            answer: "Juanes - Me Enamora",
            url: "https://soundcloud.com/juanes-unplugged/me-enamora-album-version",
          },
          {
            answer: "Carlos Baute - Colgando en tus manos (con Marta Sánchez)",
            url: "https://soundcloud.com/carlosbaute/colgando-en-tus-manos-con",
          },
          {
            url: "https://soundcloud.com/carlossadness/te-quiero-un-poco",
            answer: "Carlos Sadness - Te Quiero un Poco",
          },
          {
            answer: "Juanes - Para Tu Amor",
            url: "https://soundcloud.com/juanes-unplugged/para-tu-amor-album-version",
          },
          {
            answer: "Radio Futura - Veneno en la Piel",
            url: "https://soundcloud.com/radiofuturaofficial/veneno-en-la-piel",
          },
          {
            answer: "Miguel Bosé - Sevilla",
            url: "https://soundcloud.com/bosemiguel/sevilla-dueto-2007",
          },
          {
            answer: "Las Niñas - Oju",
            url: "https://soundcloud.com/lasninasofficial/oju",
            timeout: 500
          },
          {
            answer: "Mecano - Ay, qué pesado",
            url: "https://soundcloud.com/mecano-official/ay-que-pesado",
            timeout: 500
          },
          {
            answer: "Raphael - Mi gran noche",
            url: "https://soundcloud.com/raphael-official/mi-gran-noche",
          },
          {
            url: "https://soundcloud.com/lolita-official/sarandonga",
            answer: "Lolita - Sarandonga",
          },
          {
            answer: "Fito & Fitipaldis - Por la boca vive el pez",
            url: "https://soundcloud.com/fitoyfitipaldis/por-la-boca-vive-el-pez-1",
            timeout: 1000
          },
          {
            answer: "Pereza - Todo",
            url: "https://soundcloud.com/perezaofficial/todo",
          },
          {
            url: "https://soundcloud.com/ctangana/mala-mujer",
            answer: "C. Tangana - Mala Mujer",
          },
          {
            url: "https://soundcloud.com/pimpinela-official/olv-dame-y-pega-la-vuelta",
            answer: "Pimpinela - Olvídame y Pega la Vuelta",
            timeout: 2000
          },
          {
            answer: "Amaral - Kamikaze",
            url: "https://soundcloud.com/amaral-official/kamikaze",
          },
          {
            answer: "La Quinta Estación - Que Te Quería",
            url: "https://soundcloud.com/laquintaestacion/que-te-queria",
            timeout: 12000
          },
          {
            answer: "El Arrebato - Buscate Un Hombre Que Te Quiera",
            url: "https://soundcloud.com/el-arrebato/buscate-un-hombre-que-te",
            timeout: 2000
          },
          {
            answer: "Alejandro Sanz - No es lo mismo",
            url: "https://soundcloud.com/warnermusicspain/no-es-lo-mismo",
            timeout: 2000
          },
          {
            url: "https://soundcloud.com/enriqueiglesias/subeme-la-radio",
            answer: "Enrique Iglesias - SUBEME LA RADIO (feat. Descemer Bueno & Zion & Lennox)",
          },
          {
            answer: "Melendi - Lágrimas desordenadas",
            url: "https://soundcloud.com/melendi-official/lagrimas-desordenadas",
          },
          {
            url: "https://soundcloud.com/morat-official/c-mo-te-atreves",
            answer: "Morat - Cómo Te Atreves",
          },
          {
            url: "https://soundcloud.com/paulina-rubio-official/y-yo-sigo-aqui",
            answer: "Paulina Rubio - Y Yo Sigo Aqui",
            timeout: 15000
          },
          {
            answer: "Jarabe de Palo - La flaca",
            url: "https://soundcloud.com/jarabedepalo/la-flaca-2",
          },
          {
            answer: "Melendi - Barbie de extrarradio",
            url: "https://soundcloud.com/melendi-official/barbie-de-extrarradio",
            timeout: 1000
          },
          {
            answer: "Shakira - La Tortura",
            url: "https://soundcloud.com/shakira/la-tortura",
          },
          {
            answer: "Julieta Venegas - Me Voy",
            url: "https://soundcloud.com/Julieta Venegas/me-voy",
          },
          {
            answer: "El Arrebato - Poquito A Poco",
            url: "https://soundcloud.com/el-arrebato/poquito-a-poco",
          },
          {
            answer: "Chayanne - Torero",
            url: "https://soundcloud.com/chayanne-official/torero",
            timeout: 3000
          },
          {
            url: "https://soundcloud.com/aitana-music/formentera",
            answer: "Aitana - Formentera",
            timeout: 500
          },
          {
            answer: "Nena Daconte - En Que Estrella Estara",
            url: "https://soundcloud.com/nena-daconte-official/en-que-estrella-estara-album",
          },
          {
            answer: "El sueño de Morfeo - Si no estas",
            url: "https://soundcloud.com/el-sueno-de-morfeo/si-no-estas",
          },
          {
            answer: "Coti - Nada Fue Un Error",
            url: "https://soundcloud.com/coti-official/nada-fue-un-error-album",
          },
          {
            answer: "Andy & Lucas - Son de Amores",
            url: "https://soundcloud.com/andy-lucas-official/son-de-amores-1",
            timeout: 2000
          },
          {
            answer: "Jarabe de Palo - Depende",
            url: "https://soundcloud.com/jarabedepalo/depende-1",
          },
          {
            url: "https://soundcloud.com/sjkofficial/a-toda-mecha",
            answer: "S.J.K. - A toda mecha",
          },
          {
            answer: "El Arrebato - Dame cariño",
            url: "https://soundcloud.com/el-arrebato/dame-carino",
            timeout: 3000
          },
          {
            answer: "El sueño de Morfeo - Ojos de cielo",
            url: "https://soundcloud.com/el-sueno-de-morfeo/ojos-de-cielo",
          },
          {
            url: "https://soundcloud.com/mana-oficial/clavado-en-un-bar",
            answer: "Maná Oficial - Clavado En Un Bar",
          },
          {
            answer: "Miguel Bosé - Como un lobo ",
            url: "https://soundcloud.com/bosemiguel/como-un-lobo-dueto-2007",
            timeout: 14000
          },
          {
            url: "https://soundcloud.com/thalia-54826/no-me-acuerdo",
            answer: "Thalia - No Me Acuerdo",
          },
          {
            answer: "Macaco - Con La Mano Levantá",
            url: "https://soundcloud.com/macaco-official/con-la-mano-levanta-feat",
          },
          {
            answer: "Ricky Martin - Livin' la Vida Loca",
            url: "https://soundcloud.com/ricky-martin-official/livin-la-vida-loca-spanish",
          },
          {
            answer: "Duncan Dhu - Cien gaviotas",
            url: "https://soundcloud.com/duncan-dhu/cien-gaviotas",
          ...
          {
            url: "https://soundcloud.com/sexbomb-music/ven-ven-ven",
            answer: "Sex Bomb - Ven, Ven, Ven",
          },
          {
            answer: "Manolo García - Nunca el Tiempo Es Perdido",
            url: "https://soundcloud.com/manolo-garcia-official/nunca-el-tiempo-es-perdido",
          },
          {
            answer: "Maná Oficial - Labios Compartidos",
            url: "https://soundcloud.com/mana-oficial/labios-compartidos",
          },
          {
          ...
          {
            answer: "María Peláe- La Niña",
            url: "https://soundcloud.com/mariapelae-music/la-nina",
          },
          {
            url: "https://soundcloud.com/antonio-orozco-official/estoy-hecho-de-pedacitos-de",
            answer: "Antonio Orozco - Estoy Hecho De Pedacitos De Ti",
          },
          {
            answer: "Manolo García - Pajaros de Barro",
            url: "https://soundcloud.com/manolo-garcia-official/pajaros-de-barro",
          },
          {
            answer: "Amaia Montero - Mirando Al Mar",
            url: "https://soundcloud.com/amaia-montero/mirando-al-mar",
          },
          {
            answer: "Mecano - El 7 de Septiembre",
            url: "https://soundcloud.com/mecano-official/el-7-de-septiembre",
          },
          {
            url: "https://soundcloud.com/maria-isabel-official/no-me-toques-las-palmas-que-me",
            answer: "Maria Isabel - ¡No Me Toques Las Palmas Que Me Conozco!",
          },
          {
            answer: "Shakira - Suerte (Whenever, Wherever)",
            url: "https://soundcloud.com/shakira/suerte-whenever-wherever",
          },
          {
            answer: "Melendi - Con la luna llena",
            url: "https://soundcloud.com/melendi-official/con-la-luna-llena",
          },
          {
            url: "https://soundcloud.com/monica-naranjo-official/des-tame-1",
            answer: "Mónica Naranjo - Desátame",
          ...
          {
            answer: "Macaco - Tengo",
            url: "https://soundcloud.com/macaco-official/tengo",
          },
          {
            url: "https://soundcloud.com/camela-official/cuando-zarpa-el-amor",
            answer: "Camela - Cuando zarpa el amor",
          },
          {
            answer: "El Canto Del Loco - Eres Tonto",
            url: "https://soundcloud.com/el-canto-del-loco/eres-tonto-1",
          },
          {
            url: "https://soundcloud.com/anacano-2/salom-vivo-cantando-eurovisi-n",
            answer: "Anacano - Salomé Vivo Cantando Eurovisión 1969",
          },
          {
            answer: "Bebe - Malo",
            url: "https://soundcloud.com/bebe-official/malo-explicit",
          },
          {
            answer: "Diego Torres - Color Esperanza",
            url: "https://soundcloud.com/diego-torres-official/color-esperanza",
          },
          {
            answer: "Pereza - Lady Madrid",
            url: "https://soundcloud.com/perezaofficial/lady-madrid",
          },
          {
            answer: "Fito & Fitipaldis - Antes de que cuente diez",
            url: "https://soundcloud.com/fitoyfitipaldis/antes-de-que-cuente-diez",
          },
          {
            url: "https://soundcloud.com/rosaliaofficial/malamente",
            answer: "Rosalia - MALAMENTE (Cap.1: Augurio)",
          },
          {
            answer: "Chambao - Papeles Mojados",
            url: "https://soundcloud.com/chambao/papeles-mojados",
          },
          {
            answer: "Nena Daconte - Tenia Tanto Que Darte",
            url: "https://soundcloud.com/nena-daconte-official/tenia-tanto-que-darte-album",
          },
          {
            answer: "La Quinta Estación - Me Muero",
            url: "https://soundcloud.com/laquintaestacion/me-muero",
          },
          {
            url: "https://soundcloud.com/ms-niiina/tu-sicaria-feat-beauty-brain",
            answer: "MS NINA - Tu Sicaria",
          },
          {
            answer: "Jarabe de Palo - Bonito",
            url: "https://soundcloud.com/jarabedepalo/bonito-1",
          },
          {
            answer: "Estopa - Como Camarón",
            url: "https://soundcloud.com/estopa-official/como-camar-n",
          },
          {
            answer: "Ella baila sola - Amores de barra",
            url: "https://soundcloud.com/ella-baila-sola-official/amores-de-barra",
          },
          {
            answer: "La Quinta Estación - El Sol No Regresa",
            url: "https://soundcloud.com/laquintaestacion/el-sol-no-regresa",
          },
          {
            url: "https://soundcloud.com/chenoa-official/cuando-t-vas-album-version",
            answer: "Chenoa - Cuando Tú Vas",
          },
          {
            answer: "Despistaos - Cada dos minutos (con Rulo y la Contrabanda y Kutxi Romero)",
            url: "https://soundcloud.com/despistaos-official/cada-dos-minutos-con-rulo-de",
          },
          {
            answer: "Fito & Fitipaldis - Soldadito marinero",
            url: "https://soundcloud.com/fitoyfitipaldis/soldadito-marinero",
          },
          {
            url: "https://soundcloud.com/tino-casal-official/embrujada",
            answer: "Tino Casal - Embrujada",
          },
          {
            url: "https://soundcloud.com/badbunny15/bad-bunny-el-alfa-la-romana",
            answer: "Bad-Bunny - Bad Bunny, El Alfa - La Romana",
          },
          {
            answer: "Mecano - Me cuesta tanto olvidarte",
            url: "https://soundcloud.com/mecano-official/me-cuesta-tanto-olvidarte",
          },
          {
            url: "https://soundcloud.com/patriciamanterola/que-el-ritmo-no-pare",
            answer: "Patricia Manterola - Que El Ritmo No Pare",
          },
          {
            answer: "La Oreja De Van Gogh - Cuentame al Oido",
            url: "https://soundcloud.com/la-oreja-de-van-gogh/cuentame-al-oido",
          },
          {
            answer: 'Amaia Montero - 4 "',
            url: "https://soundcloud.com/amaia-montero/4-1",
          },
          {
            answer: "Coti - Antes Que Ver El Sol",
            url: "https://soundcloud.com/coti-official/antes-que-ver-el-sol-bonus",
          },
          {
            answer: "El Canto Del Loco - Besos",
            url: "https://soundcloud.com/el-canto-del-loco/besos",
          },
          {
            url: "https://soundcloud.com/ayem101424/te-bote-remix-feat-darell",
            answer: "Ay Em - Te Boté (Remix) [feat. Darell, Nicky Jam & Ozuna]",
          },
          {
            answer: "Fangoria - Dramas y comedias",
            url: "https://soundcloud.com/fangoria-official/dramas-y-comedias",
          },
          {
            answer: "Antonio Flores - Isla de Palma",
            url: "https://soundcloud.com/antonio-flores-official/isla-de-palma",
          },
          {
            answer: "Antonio Flores - Siete Vidas",
            url: "https://soundcloud.com/antonio-flores-official/siete-vidas",
          },
          {
            answer: "El sueño de Morfeo - Esta soy yo",
            url: "https://soundcloud.com/el-sueno-de-morfeo/esta-soy-yo",
          },
          {
            answer: "La Musicalité - Cuatro elementos",
            url: "https://soundcloud.com/la-musicalite/cuatro-elementos",
          },
          {
            url: "https://soundcloud.com/iambeckyg/sin-pijama",
            answer: "Becky G - Becky G & Natti Natasha - Sin Pijama",
          },
          {
            url: "https://soundcloud.com/sonia-y-selena/yo-quiero-bailar-1",
            answer: "Sonia Y Selena - Yo Quiero Bailar",
          },
          {
            url: "https://soundcloud.com/shakira/si-te-vas",
            answer: "Shakira - Si Te Vas",
          },
          {
            answer: "El Barrio - Quiereme",
            url: "https://soundcloud.com/el-barrio-official/quiereme",
          },
          {
            url: "https://soundcloud.com/anamenaofficial/musica-ligera",
            answer: "Ana Mena - Música Ligera",
          },
          {
            url: "https://soundcloud.com/shakira/chantaje",
            answer: "Shakira - Chantaje (feat. Maluma)",
          },
          {
            url: "https://soundcloud.com/azucar-moreno-official/solo-se-vive-una-vez-1",
            answer: "Azucar Moreno - Solo Se Vive una Vez",
          },
          {
            answer: "Hombres G - Devuelveme A Mi Chica",
            url: "https://soundcloud.com/warnermusicspain/devuelveme-a-mi-chica",
          },
          {
            url: "https://soundcloud.com/david-bisbal-official/oye-el-boom-album-version",
            answer: "David Bisbal - Oye El Boom",
          },
          {
            answer: "Miguel Bosé - Aire soy",
            url: "https://soundcloud.com/bosemiguel/aire-soy-feat-ximena-sari-ana",
          },
          {
            url: "https://soundcloud.com/maria-isabel-official/antes-muerta-que-sencilla",
            answer: "Maria Isabel - Antes Muerta Que Sencilla",
          },
        ],
        Pn
      ).subscribe,
    ...
    return {
      c() {
        ...
        Q(l.$$.fragment),
          ...
          (C = x()),
          H && H.c(),
          (An.title = "HeardlEsp - Heardle pero ahora en español"),
          M(t, "name", "description"),
          M(
            t,
            "content",
            "Adivina la canción en el menor número de intentos posibles"
          ),
      ...
      function (e) {
         ...
         if (r)
           r ? (pe("skippedGuess", {
             ...
             t == l.correctAnswer ? (s = !0,
               pe("correctGuess", {
                 name: "correctGuess"
               }),
               pe("correctGuess#" + r.id, {
                 name: "correctGuess"
               })) : t.split('-')[0] == l.correctAnswer.split('-')[0]&& (u = !0,
               pe("correctArtist", {
                 name: "correctArtist"
               }),
